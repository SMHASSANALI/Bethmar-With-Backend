    ...
    <main className='bg-[#f9f9f9] py-8'>
      <div className='max-w-[1500px] mx-auto rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] p-4 bg-white text-gray-800'>
        <div className='mb-8 py-[30px]'>
          <span className='text-sm bg-accentGreen px-3 py-1 rounded-full inline-block mb-1 text-white'>
            We’re hiring!
          </span>
          ...
          <div className='space-y-[30px]'>
            {jobListings.map((job, index) => (
              ...
              >
                ...
                <button
                  onClick={() => onClick(job)}
                  className='group mt-4 md:mt-0 flex items-center gap-2 text-primary font-medium hover:bg-primary hover:text-white pr-2 pl-4 py-2 rounded-full transition-all ease-in-out'
                >
                  Apply
                  <img
                    ...
                    className='group-hover:rotate-0 -rotate-45 transition-all ease-in-out duration-200 w-7 h-7 p-1 bg-[#26803d] rounded-full'
                    alt=''
                  />
                </button>
              </div>
