    ...
    <div className='flex items-center justify-center'>
      <div className='bg-gradient-to-b from-[#F6F6F6] to-[#f1f1f1] w-full rounded min-h-[80%] flex items-center lg:py-6 py-12'>
        ...
        >
          ...
          >
            <h1 className='tracking-wide leading-tight font-oswald text-2xl lg:text-4xl font-semibold text-white'>
              Building Infrastructure Solutions for a Connected World
            </h1>
            <p className='text-sm lg:text-base font-light font-Poppins my-4 px-1 text-slate-100'>
              Bethmar is a leading infrastructure company based in the UK. We
              specialize in providing Full Turnkey Telecom Service, civil
              infrastructure solutions, traffic management, and high-speed
              solutions. With expertise in construction of spill tanks, EV
              charging installation, DNO liaison, meter installation, and solar
              park data centre solutions, we are committed to delivering
              exceptional services since <span className='font-bold'>2013</span>
              .
            </p>
