  ...
  return (
    <>
      <div
        style={divStyle}
        id='Services'
        className='flex justify-center items-center lg:py-12 '
      >
            ...
            <div className=' flex flex-col lg:flex-row py-6'>
              ...
              >
                <p className='text-sm lg:text-base font-light font-poppins text-primary-light'>
                  At Bethmar, we offer a wide range of infrastructure, telecom,
                  and traffic management services to meet your specific
                  requirements. From full telecom turnkey to traffic management
                  solutions, our experienced team is dedicated to delivering
              ...
              <motion.div variants={fadeInUp} className='rounded  p-4'>
                ...
                <ul>
                  ...
                  <li className='flex flex-row gap-x-2 text-base font-light text-gray-600 items-start py-1'>
                    ...
                    EL Joint User Pole installations
                  </li>
                  <li className='flex flex-row gap-x-2 text-base font-light text-gray-600 items-start py-1'>
                    {' '}
                    <span className='my-1 text-white'>
              ...
              <motion.div variants={fadeInUp} className='rounded  p-4'>
                ...
                <ul>
                  ...
                  {/* <li className='flex flex-row gap-x-2 text-base font-light text-gray-600 items-start py-1'>
                    ...
                    Temporary Multi-Phase Traffic lights
                  </li>
                  <li className='flex flex-row gap-x-2 text-base font-light text-gray-600 items-start py-1'>
                    {' '}
                    <span className='my-1 text-white'>
