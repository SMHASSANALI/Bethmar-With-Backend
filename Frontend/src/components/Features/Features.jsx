...
const HoverCards = ({ image, title, description, svg }) => {
  ...
  return (
    <div
      className='h-full w-full flex flex-col max-w-lg relative group lg:min-h-[40vh] cursor-pointer rounded-lg'
...
const Features = ({ data }) => {
  ...
  return (
    ...
    >
      <div
        ref={imgRef}
        className='max-w-[1500px] flex rounded items-center lg:py-6 py-12 relative'
      >
        <div className='absolute z-10 left-00'>
          <motion.img
            src={B}
            alt=''
        ...
        <div ref={ref} className='max-w-[1500px] lg:px-0 px-4 mx-auto relative'>
          <div className='w-full xl:w-6/12 mx-auto'>
            ...
            >
              At Bethmar, we specialize in offering a wide range of services to
              meet your unique requirements. With our expertise and dedication,
              we deliver top-quality solutions that exceed expectations.
            </motion.p>
          </div>
