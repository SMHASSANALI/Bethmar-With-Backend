...
const Navbar = () => {
  ...
  const { setUser, user, logout } = context;
  ...
  return (
    <div className="z-[9999] w-full text-white bg-neutral-900 sticky top-0">
      <section className=" bg-neutral-800">
        <div className="flex md:flex-row flex-col justify-between items-end max-w-[1500px] text-xs mx-auto py-2 gap-[10px]">
          <div className="flex items-center gap-3 px-4">
            ...
            >
              ...
              <p className="text-sm font-poppins group-hover:text-blue-600 transition-colors duration-300">
                Facebook
              </p>
            </a>
            <a
              href="https://www.linkedin.com/in/bethmar-limited-47a762244/?trk=public_post_reshare_feed-actor-name&originalSubdomain=uk"
              className="flex items-end gap-1 group transition-colors duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              ...
              <span className="text-sm font-poppins group-hover:text-blue-400 transition-colors duration-300">
                LinkedIn
              </span>
            </a>
            <a
              href="https://www.jcoffey.com"
              className="rounded-sm overflow-hidden flex items-end gap-1 group text-white hover:text-green-500 transition-colors duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img src={jCoffey} className="size-5" />
              <span className="sm:text-xs text-sm font-poppins group-hover:text-green-500 transition-colors duration-300">
                J Coffey
              </span>
            </a>
          </div>
